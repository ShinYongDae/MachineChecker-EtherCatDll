...
///*_T("windows.h"), so the WIN32 sections are moved here.                        */
//#define		API			_stdcall
//#else
...
////2011.06.30 VER 200
//INT API HardwareReset(INT Board);
//
...
//INT API get_option_out_io_bit(INT port, INT bit, pINT status);
//
...
//// JJS 2014-01-07
//INT API set_joystick_enable(INT bdNum, INT Enable);
//INT API set_joystick_velocity(INT bdNum, INT vel0, INT vel1, INT vel2, INT vel3);
//INT API get_joystick_enable(INT bdNum, pINT Enable);
//INT API get_joystick_velocity(INT bdNum, pINT vel0, pINT vel1, pINT vel2, pINT vel3);
//
